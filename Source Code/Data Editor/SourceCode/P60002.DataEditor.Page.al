page 60002 "Data Editor"
{
    ...
    trigger OnOpenPage()
    begin
        // IF not ((UPPERCASE(USERID) = 'GULSHAN.KUMAR') OR (UPPERCASE(USERID) = 'DALIP.RONGTA') OR (UPPERCASE(USERID) = 'JORAVAR.SINGH') OR (UPPERCASE(USERID) = 'SUPER')
        // OR (UPPERCASE(USERID) = 'PUNEET.K') OR (UPPERCASE(USERID) = 'TRIDENT')) OR (UPPERCASE(USERID) = 'DEVUSER') then
    ...
    var
        DataEditorBufferList: Page "Data Editor Buffer";
    begin
